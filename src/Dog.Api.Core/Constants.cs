...
public static class Constants
{
    ...
    public static class ErrorMessages
    {
        ...
        public const string PageNumberTooSmall = "Page number should be greater than or equal to 0";
        public const string PageSizeTooLarge = "Page size should be less than or equal to 20";
        public const string PageSizeTooSmall = "Page size should be greater or equal to 0";
    }
}
